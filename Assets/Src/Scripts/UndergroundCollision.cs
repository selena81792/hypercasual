    ...
    void OnTriggerEnter (Collider other)
    {
        ...
        if (!Game.isGameover) {
            ...
            if (tag.Equals ("Object")) { 
                PlayerPrefs.SetInt("gold", currentGold + 1);
                ...
                Level.Instance.Effects.PlayOneShot(Level.Instance.effect1);
                ...
                if (Level.Instance.objectsInScene == 0) {
                    ...
                    Level.Instance.Effects.PlayOneShot(Level.Instance.win);
            ...
            if (tag.Equals ("Obstacle")) {
                ...
                Camera.main.transform
                    ...
                    Level.Instance.Effects.PlayOneShot(Level.Instance.lose);
